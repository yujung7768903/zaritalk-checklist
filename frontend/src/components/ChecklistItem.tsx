...
export default function ChecklistItem({ item, completed, onToggle, onDetail }: Props) {
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3.5 border-b border-bg last:border-b-0 ${
    ...
    >
      ...
      <button className="flex-1 flex items-center justify-between gap-3 text-left min-w-0 cursor-pointer" onClick={onDetail}>
        ...
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0 text-border-strong">
